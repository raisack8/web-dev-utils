...
const sidebarVariants = cva(
  "group peer hidden md:flex h-full w-[--sidebar-width] flex-col border-r border-sidebar-border bg-sidebar text-sidebar-foreground",
  {
    variants: {
      variant: {
        sidebar: "peer-data-[variant=inset]:hidden",
        floating: "p-2 peer-data-[variant=inset]:shadow-outline",
        inset:
          "peer-data-[variant=inset]:relative peer-data-[variant=inset]:bg-background peer-data-[variant=inset]:border-sidebar-border",
      },
      side: {
        left: "",
        right: "order-last",
      ...
      collapsible: {
        offcanvas: "peer-data-[state=collapsed]:hidden",
        icon: "peer-data-[state=collapsed]:w-[--sidebar-width-icon]",
        none: "",
      },
    },
    defaultVariants: {
